import 'package:firebaselogin/register_page.dart';
...
class LoginPage extends StatefulWidget {
  ...
  @override
  State<LoginPage> createState() => _SignInThreeState();
}

class _SignInThreeState extends State<LoginPage> {
  ...
  Widget signInButton(Size size) {
    return Container(
      ...
      child: ElevatedButton(
        ...
        onPressed: () {
          AuthService().signIn(context, email: emailController.text, password: passController.text);
        },
        child: Text(
          'Giriş Yap',
          style: GoogleFonts.inter(
